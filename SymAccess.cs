// Adapted from "CLR Managed Debugger (mdbg) Sample, v2.1"
// (http://www.microsoft.com/en-ca/download/details.aspx?id=19621)
//
// Initially inspired by "How to read PDB files"
// and http://sorin.serbans.net/blog/?p=257
...
namespace Microsoft.Samples.Debugging.CorSymbolStore
{
    ...
    public static class SymbolAccess
    {
        ...
        {
            return GetReaderForFile(new SymBinder(), pathModule, searchPath);
        }
        /*
         ...
         */
        private static ISymbolReader GetReaderForFile(SymBinder binder, string pathModule, string searchPath)
        {
